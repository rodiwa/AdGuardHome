...
const Counters = ({ refreshButton, subtitle }) => {
    ...
    const rows = [
        ...
        },
        {
            ...
            translationComponents: [<Link to={`logs?response_status=${RESPONSE_FILTER.FILTERED.QUERY}`} key="0">link</Link>],
        },
        {
            ...
            href: `logs?response_status=${RESPONSE_FILTER.BLOCKED_THREATS.QUERY}`,
        },
        {
            label: 'stats_adult',
            ...
            href: `logs?response_status=${RESPONSE_FILTER.BLOCKED_ADULT_WEBSITES.QUERY}`,
        },
        {
            ...
            href: `logs?response_status=${RESPONSE_FILTER.SAFE_SEARCH.QUERY}`,
        },
        {
